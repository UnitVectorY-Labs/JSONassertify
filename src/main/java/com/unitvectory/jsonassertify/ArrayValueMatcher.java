 ...
 * array element components against a regular expression pattern. As a
 * convenience to reduce syntactic complexity of expected string, if the
 ...
 *
 * <p>
 * To simplify complexity of expected JSON string, the value
 * <code>"a:[{id:1}]}"</code> may be replaced by <code>"a:{id:1}}"</code>
 * </p>
 * 
 * <p>
 * To verify that the 'type' attribute of second and third elements of array 'a'
 * is 'row':
 * </p>
 * 
 * <pre>{@code
 ...
 * 
 * <p>
 * To verify that the 'id' attribute of every element of array 'a' matches
 * regular expression '\d+'. This requires a custom comparator to specify
 * regular expression to be used to validate each array element, hence the array
 * of Customization instances:
 * </p>
 * 
 * <pre>{@code
 ...
 * RegularExpressionValueMatcher<Object> regExValueMatcher = new RegularExpressionValueMatcher<Object>("\\d+"); // matches
 * 																												// one
 * 																												// or
 * 																												// more
 * 																												// digits
 ...
 * CustomComparator regExCustomArrayValueComparator = new CustomComparator(JSONCompareMode.STRICT_ORDER,
 ...
 * 
 * <p>
 * To verify that the 'background' attribute of every element of array 'a'
 * alternates between 'white' and 'grey' starting with first element
 ...
 * 
 * <p>
 * Assuming JSON to be verified is held in String variable ARRAY_OF_JSONARRAYS
 * and contains:
 * </p>
 * 
 ...
 * 
 * <p>
 * To verify that the first three elements of JSON array 'a' are JSON arrays of
 * length 3:
 * </p>
 * 
 * <pre>{@code
 ...
 * JSONAssert.assertEquals("{a:[[3]]}", ARRAY_OF_JSONARRAYS,
 * 		new CustomComparator(JSONCompareMode.LENIENT, customization));
 * }</pre>
 *
 * <p>
 * NOTE: simplified expected JSON strings are not possible in this case as
 * ArraySizeComparator does not support them.
 * </p>
 * 
 * <p>
 * To verify that the second elements of JSON array 'a' is a JSON array whose
 * first element has the value 9:
 * </p>
 * 
 * <pre>{@code
 ...
 * <p>
 * To simplify complexity of expected JSON string, the value
 * <code>"{a:[[9]]}"</code> may be replaced by <code>"{a:[9]}"</code> or
 * <code>"{a:9}"</code>
 * </p>
 * 
