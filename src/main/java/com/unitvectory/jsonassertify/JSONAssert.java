 ...
 *
 * <p>
 * There are two modes, strict and non-strict. In most cases, you will probably
 * want
 * to set strict to <i>false</i>, since that will make the tests less brittle.
 * </p>
 *
 * <p>
 * Strict tests require all of the elements requested to be returned, and only
 * those elements
 * (ie, the tests are non-extensible). Arrays of elements must be returned in
 * the same
 ...
 *
 * <p>
 * The following would match when doing non-strict checking, but would fail on
 * strict checking:
 * </p>
 *
 ...
 *
 * <p>
 * <i>This library uses org.json. It has fewer dependencies than other JSON
 * libraries (like net.sf.json),
 * making JSONassert more portable.</i>
 * </p>
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>Unless the order is strict, checking does not handle mixed types in the
 * JSONArray
 * (e.g. <code>[1,2,{a:"b"}]</code> or
 ...
 * </ul>
 * <p>
 * You do not have to worry about encountering a false positive or false
 * negative in these two edge cases.
 * <i>JSONassert</i> will identify the conditions and throw a descriptive
 * {@link IllegalArgumentException}. These
...
public class JSONAssert {
    ...
    /**
     * Asserts that the JSONObject provided matches the expected string. If it isn't
     * it throws an
     * {@link AssertionError}.
     *
    ...
    /**
     * Asserts that the JSONObject provided does not match the expected string. If
     * it is it throws an
     * {@link AssertionError}.
     * 
    ...
    /**
     * Asserts that the JSONArray provided matches the expected string. If it isn't
     * it throws an
     * {@link AssertionError}.
     *
     * @param expectedStr Expected JSON string
    ...
    /**
     * Asserts that the JSONArray provided does not match the expected string. If it
     * is it throws an
     * {@link AssertionError}.
     * 
     * @param expectedStr Expected JSON string
    ...
    /**
     * Asserts that the json string provided matches the expected string. If it
     * isn't it throws an
     * {@link AssertionError}.
     *
     * @param expectedStr Expected JSON string
    ...
    /**
     * Asserts that the json string provided does not match the expected string. If
     * it is it throws an
     * {@link AssertionError}.
     * 
     * @param expectedStr Expected JSON string
    ...
    /**
     * Asserts that the JSONObject provided matches the expected JSONObject. If it
     * isn't it throws an
     * {@link AssertionError}.
     *
    ...
    /**
     * Asserts that the JSONArray provided matches the expected JSONArray. If it
     * isn't it throws an
     * {@link AssertionError}.
     *
    ...
    /**
     * Asserts that the JSONArray provided does not match the expected JSONArray. If
     * it is it throws an
     * {@link AssertionError}.
     * 
     * @param expected Expected JSONArray
